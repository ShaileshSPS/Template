  ...
  <div class="container">
    <div class="row">
      <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 schedule-demo">
        <img src="./assets/images/common/hl_logo.png" width="100%">
  ...
  <div class="container-fluid">
    <div class="row footer-row">
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
        <a href="/<?php echo explode('/', $_SERVER['REQUEST_URI'])[1] ?>"><img class="ml-3" src="./assets/images/common/footer_logo.png" width="100px"></a>
      ...
      <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12 mt-4">
        <ul>      
          <li class="font-roboto-regular mt-4"><a href="about.php">About</a></li>
          <li class="font-roboto-regular"><a href="services.php">Services</a></li>
          <li class="font-roboto-regular"><a href="work.php">Work</a></li>
          <li class="font-roboto-regular"><a href="contact.php">Contact Us</a></li>
        </ul>
      </div>
